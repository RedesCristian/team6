...
async function openModal(id) {
  ...
  const isWatched = checkMovieInLibrary('watched', id);
  const isQueued = checkMovieInLibrary('queue', id);
  ...
  const modalContent = `
    ...
    movieData.vote_count
        ...
        <div class="cards-modal-buttons">
          <button id="toggle-watched" class="cards-modal-button watch">${
            isWatched ? 'REMOVE FROM WATCHED' : 'ADD TO WATCHED'
          }</button>
          <button id="toggle-queue" class="cards-modal-button queue">${
